...
Thanks for wanting to help improve **race**!  
...
1. **Check if it’s already reported**  
   Look through the existing [Issues](https://github.com/viktor45/race/issues) to see if someone else has already reported the same problem.

2. **Report it if it’s new**  
   If you don’t see it listed, please [open a new bug report](https://github.com/viktor45/race/issues/new?template=🐞-bug-report.md).  
...
1. **Share your idea**  
   Open a [feature request](https://github.com/viktor45/race/issues/new?template=💡-feature-request.md) to describe what you’d like to add or improve.
...
Every bit of help—whether it’s a typo fix or a big new feature—makes **race** better for everyone.  
